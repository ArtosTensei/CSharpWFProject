...
namespace PP {
    ...
    public partial class ppDataSet : global::System.Data.DataSet {
        ...
        public partial class characterDataTable : global::System.Data.TypedTableBase<characterRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public characterRow AddcharacterRow(int idCharacter, string name, int lvl, string _class) {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public characterRow FindByidCharacter(int idCharacter) {
        ...
        public partial class characterRow : global::System.Data.DataRow {
            ...
            public int idCharacter {
                get {
                    return ((int)(this[this.tablecharacter.idCharacterColumn]));
                }
                set {
                    this[this.tablecharacter.idCharacterColumn] = value;
                }
            }
...
namespace PP.ppDataSetTableAdapters {
    ...
    public partial class characterTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `character` WHERE ((`idCharacter` = @p1) AND (`name` = @p2) AND (`lvl" +
                "` = @p3) AND (`class` = @p4))";
            ...
            param.SourceColumn = "idCharacter";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `character` (`idCharacter`, `name`, `lvl`, `class`) VALUES (@p1, @p2," +
                " @p3, @p4)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE `character` SET `idCharacter` = @p1, `name` = @p2, `lvl` = @p3, `class` = " +
                "@p4 WHERE ((`idCharacter` = @p5) AND (`name` = @p6) AND (`lvl` = @p7) AND (`clas" +
                "s` = @p8))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::PP.Properties.Settings.Default.ppConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT `idCharacter`, `name`, `lvl`, `class` FROM `character`";
        ...
        public virtual int Fill(ppDataSet.characterDataTable dataTable) {
        ...
        public virtual ppDataSet.characterDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            ppDataSet.characterDataTable dataTable = new ppDataSet.characterDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(ppDataSet.characterDataTable dataTable) {
